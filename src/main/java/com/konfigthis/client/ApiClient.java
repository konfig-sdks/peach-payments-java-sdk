...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://testapi-v2.peachpayments.com";
    ...
    private void init() {
        ...
        setUserAgent("Konfig/2.0.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://testapi-v2.peachpayments.com)
