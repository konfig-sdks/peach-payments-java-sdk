...
public class CheckoutV2Billing {
  ...
  public CheckoutV2Billing() {
  }

  public CheckoutV2Billing street1(String street1) {
  ...
  **/
  ...
  public CheckoutV2Billing street2(String street2) {
  ...
  **/
  ...
  public CheckoutV2Billing city(String city) {
  ...
  **/
  ...
  public CheckoutV2Billing company(String company) {
  ...
  **/
  ...
  public CheckoutV2Billing country(String country) {
  ...
  **/
  ...
  public CheckoutV2Billing state(String state) {
  ...
  **/
  ...
  public CheckoutV2Billing postcode(String postcode) {
  ...
  **/
   ...
   * @return the CheckoutV2Billing instance itself
   */
  public CheckoutV2Billing putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CheckoutV2Billing checkoutV2Billing = (CheckoutV2Billing) o;
    return Objects.equals(this.street1, checkoutV2Billing.street1) &&
        Objects.equals(this.street2, checkoutV2Billing.street2) &&
        Objects.equals(this.city, checkoutV2Billing.city) &&
        Objects.equals(this.company, checkoutV2Billing.company) &&
        Objects.equals(this.country, checkoutV2Billing.country) &&
        Objects.equals(this.state, checkoutV2Billing.state) &&
        Objects.equals(this.postcode, checkoutV2Billing.postcode)&&
        Objects.equals(this.additionalProperties, checkoutV2Billing.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(street1, street2, city, company, country, state, postcode, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CheckoutV2Billing {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CheckoutV2Billing
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CheckoutV2Billing.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckoutV2Billing is not found in the empty JSON string", CheckoutV2Billing.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckoutV2Billing.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckoutV2Billing' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckoutV2Billing> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckoutV2Billing.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckoutV2Billing>() {
           @Override
           public void write(JsonWriter out, CheckoutV2Billing value) throws IOException {
           ...
           @Override
           public CheckoutV2Billing read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CheckoutV2Billing instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CheckoutV2Billing given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CheckoutV2Billing
  * @throws IOException if the JSON string is invalid with respect to CheckoutV2Billing
  */
  public static CheckoutV2Billing fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckoutV2Billing.class);
  }

 /**
  * Convert an instance of CheckoutV2Billing to an JSON string
  *
  * @return JSON string
  */
