 ...
 */
@ApiModel(description = "Webhook sent when a checkout instance is created.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CheckoutCreatedWebhook {
 ...
 public enum PaymentTypeEnum {
  ...
  private String resultCode = "000.200.100";
  ...
  private String resultDescription = "successfully created checkout";
  ...
  public CheckoutCreatedWebhook() {
  }

  public CheckoutCreatedWebhook amount(String amount) {
  ...
  **/
  ...
  public CheckoutCreatedWebhook checkoutId(String checkoutId) {
  ...
  **/
  ...
  public CheckoutCreatedWebhook currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public CheckoutCreatedWebhook merchantTransactionId(String merchantTransactionId) {
  ...
  **/
  ...
  public CheckoutCreatedWebhook paymentType(PaymentTypeEnum paymentType) {
  ...
  **/
  ...
  public CheckoutCreatedWebhook resultCode(String resultCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "000.200.100", value = "")
  ...
  public CheckoutCreatedWebhook resultDescription(String resultDescription) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "successfully created checkout", value = "")
  ...
  public CheckoutCreatedWebhook signature(String signature) {
  ...
  **/
  ...
  public CheckoutCreatedWebhook timestamp(String timestamp) {
  ...
  **/
   ...
   * @return the CheckoutCreatedWebhook instance itself
   */
  public CheckoutCreatedWebhook putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CheckoutCreatedWebhook checkoutCreatedWebhook = (CheckoutCreatedWebhook) o;
    return Objects.equals(this.amount, checkoutCreatedWebhook.amount) &&
        Objects.equals(this.checkoutId, checkoutCreatedWebhook.checkoutId) &&
        Objects.equals(this.currency, checkoutCreatedWebhook.currency) &&
        Objects.equals(this.merchantTransactionId, checkoutCreatedWebhook.merchantTransactionId) &&
        Objects.equals(this.paymentType, checkoutCreatedWebhook.paymentType) &&
        Objects.equals(this.resultCode, checkoutCreatedWebhook.resultCode) &&
        Objects.equals(this.resultDescription, checkoutCreatedWebhook.resultDescription) &&
        Objects.equals(this.signature, checkoutCreatedWebhook.signature) &&
        Objects.equals(this.timestamp, checkoutCreatedWebhook.timestamp)&&
        Objects.equals(this.additionalProperties, checkoutCreatedWebhook.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CheckoutCreatedWebhook {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CheckoutCreatedWebhook
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CheckoutCreatedWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckoutCreatedWebhook is not found in the empty JSON string", CheckoutCreatedWebhook.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckoutCreatedWebhook.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckoutCreatedWebhook' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckoutCreatedWebhook> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckoutCreatedWebhook.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckoutCreatedWebhook>() {
           @Override
           public void write(JsonWriter out, CheckoutCreatedWebhook value) throws IOException {
           ...
           @Override
           public CheckoutCreatedWebhook read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CheckoutCreatedWebhook instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CheckoutCreatedWebhook given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CheckoutCreatedWebhook
  * @throws IOException if the JSON string is invalid with respect to CheckoutCreatedWebhook
  */
  public static CheckoutCreatedWebhook fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckoutCreatedWebhook.class);
  }

 /**
  * Convert an instance of CheckoutCreatedWebhook to an JSON string
  *
  * @return JSON string
  */
