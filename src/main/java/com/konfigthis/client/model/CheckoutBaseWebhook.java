 ...
 */
@ApiModel(description = "The base model for webhooks.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CheckoutBaseWebhook {
 ...
 public enum PaymentTypeEnum {
  ...
  public CheckoutBaseWebhook() {
  }

  public CheckoutBaseWebhook amount(String amount) {
  ...
  **/
  ...
  public CheckoutBaseWebhook checkoutId(String checkoutId) {
  ...
  **/
  ...
  public CheckoutBaseWebhook currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public CheckoutBaseWebhook merchantTransactionId(String merchantTransactionId) {
  ...
  **/
  ...
  public CheckoutBaseWebhook paymentType(PaymentTypeEnum paymentType) {
  ...
  **/
  ...
  public CheckoutBaseWebhook resultCode(String resultCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A code representing the checkout state.")
  ...
  public CheckoutBaseWebhook resultDescription(String resultDescription) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A friendly message.")
  ...
  public CheckoutBaseWebhook signature(String signature) {
  ...
  **/
  ...
  public CheckoutBaseWebhook timestamp(String timestamp) {
  ...
  **/
   ...
   * @return the CheckoutBaseWebhook instance itself
   */
  public CheckoutBaseWebhook putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CheckoutBaseWebhook checkoutBaseWebhook = (CheckoutBaseWebhook) o;
    return Objects.equals(this.amount, checkoutBaseWebhook.amount) &&
        Objects.equals(this.checkoutId, checkoutBaseWebhook.checkoutId) &&
        Objects.equals(this.currency, checkoutBaseWebhook.currency) &&
        Objects.equals(this.merchantTransactionId, checkoutBaseWebhook.merchantTransactionId) &&
        Objects.equals(this.paymentType, checkoutBaseWebhook.paymentType) &&
        Objects.equals(this.resultCode, checkoutBaseWebhook.resultCode) &&
        Objects.equals(this.resultDescription, checkoutBaseWebhook.resultDescription) &&
        Objects.equals(this.signature, checkoutBaseWebhook.signature) &&
        Objects.equals(this.timestamp, checkoutBaseWebhook.timestamp)&&
        Objects.equals(this.additionalProperties, checkoutBaseWebhook.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CheckoutBaseWebhook {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CheckoutBaseWebhook
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CheckoutBaseWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckoutBaseWebhook is not found in the empty JSON string", CheckoutBaseWebhook.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckoutBaseWebhook.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckoutBaseWebhook' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckoutBaseWebhook> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckoutBaseWebhook.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckoutBaseWebhook>() {
           @Override
           public void write(JsonWriter out, CheckoutBaseWebhook value) throws IOException {
           ...
           @Override
           public CheckoutBaseWebhook read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CheckoutBaseWebhook instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CheckoutBaseWebhook given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CheckoutBaseWebhook
  * @throws IOException if the JSON string is invalid with respect to CheckoutBaseWebhook
  */
  public static CheckoutBaseWebhook fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckoutBaseWebhook.class);
  }

 /**
  * Convert an instance of CheckoutBaseWebhook to an JSON string
  *
  * @return JSON string
  */
