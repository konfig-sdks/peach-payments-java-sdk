 ...
 */
@ApiModel(description = "Webhook sent when a checkout instance is cancelled.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CheckoutCancelledWebhook {
 ...
 public enum PaymentTypeEnum {
  ...
  private String resultCode = "100.396.101";
  ...
  private String resultDescription = "Cancelled by user";
  ...
  public CheckoutCancelledWebhook() {
  }

  public CheckoutCancelledWebhook amount(String amount) {
  ...
  **/
  ...
  public CheckoutCancelledWebhook checkoutId(String checkoutId) {
  ...
  **/
  ...
  public CheckoutCancelledWebhook currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public CheckoutCancelledWebhook merchantTransactionId(String merchantTransactionId) {
  ...
  **/
  ...
  public CheckoutCancelledWebhook paymentType(PaymentTypeEnum paymentType) {
  ...
  **/
  ...
  public CheckoutCancelledWebhook resultCode(String resultCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.396.101", value = "")
  ...
  public CheckoutCancelledWebhook resultDescription(String resultDescription) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Cancelled by user", value = "")
  ...
  public CheckoutCancelledWebhook signature(String signature) {
  ...
  **/
  ...
  public CheckoutCancelledWebhook timestamp(String timestamp) {
  ...
  **/
   ...
   * @return the CheckoutCancelledWebhook instance itself
   */
  public CheckoutCancelledWebhook putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CheckoutCancelledWebhook checkoutCancelledWebhook = (CheckoutCancelledWebhook) o;
    return Objects.equals(this.amount, checkoutCancelledWebhook.amount) &&
        Objects.equals(this.checkoutId, checkoutCancelledWebhook.checkoutId) &&
        Objects.equals(this.currency, checkoutCancelledWebhook.currency) &&
        Objects.equals(this.merchantTransactionId, checkoutCancelledWebhook.merchantTransactionId) &&
        Objects.equals(this.paymentType, checkoutCancelledWebhook.paymentType) &&
        Objects.equals(this.resultCode, checkoutCancelledWebhook.resultCode) &&
        Objects.equals(this.resultDescription, checkoutCancelledWebhook.resultDescription) &&
        Objects.equals(this.signature, checkoutCancelledWebhook.signature) &&
        Objects.equals(this.timestamp, checkoutCancelledWebhook.timestamp)&&
        Objects.equals(this.additionalProperties, checkoutCancelledWebhook.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CheckoutCancelledWebhook {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CheckoutCancelledWebhook
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CheckoutCancelledWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckoutCancelledWebhook is not found in the empty JSON string", CheckoutCancelledWebhook.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckoutCancelledWebhook.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckoutCancelledWebhook' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckoutCancelledWebhook> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckoutCancelledWebhook.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckoutCancelledWebhook>() {
           @Override
           public void write(JsonWriter out, CheckoutCancelledWebhook value) throws IOException {
           ...
           @Override
           public CheckoutCancelledWebhook read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CheckoutCancelledWebhook instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CheckoutCancelledWebhook given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CheckoutCancelledWebhook
  * @throws IOException if the JSON string is invalid with respect to CheckoutCancelledWebhook
  */
  public static CheckoutCancelledWebhook fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckoutCancelledWebhook.class);
  }

 /**
  * Convert an instance of CheckoutCancelledWebhook to an JSON string
  *
  * @return JSON string
  */
