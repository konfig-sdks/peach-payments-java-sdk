 ...
 */
@ApiModel(description = "The options object contains all the communication preferences for the payment link.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PaymentOptions {
  ...
  private Integer expiryTime = 43200;
  ...
  public PaymentOptions sendEmail(Boolean sendEmail) {
  ...
  **/
  ...
  public PaymentOptions sendSms(Boolean sendSms) {
  ...
  **/
  ...
  public PaymentOptions sendWhatsapp(Boolean sendWhatsapp) {
  ...
  **/
  ...
  public PaymentOptions emailCc(String emailCc) {
  ...
  **/
  ...
  public PaymentOptions emailBcc(String emailBcc) {
  ...
  **/
  ...
  public PaymentOptions expiryTime(Integer expiryTime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5", value = "Time in minutes until the link expires. By default, expiry time is set to 30 days, which is also the maximum expiry time.")
  ...
  public PaymentOptions notificationUrl(String notificationUrl) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sendEmail, paymentOptions.sendEmail) &&
        Objects.equals(this.sendSms, paymentOptions.sendSms) &&
        Objects.equals(this.sendWhatsapp, paymentOptions.sendWhatsapp) &&
        Objects.equals(this.emailCc, paymentOptions.emailCc) &&
        Objects.equals(this.emailBcc, paymentOptions.emailBcc) &&
        Objects.equals(this.expiryTime, paymentOptions.expiryTime) &&
        Objects.equals(this.notificationUrl, paymentOptions.notificationUrl)&&
        Objects.equals(this.additionalProperties, paymentOptions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sendEmail, sendSms, sendWhatsapp, emailCc, emailBcc, expiryTime, notificationUrl, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if ((jsonObj.get("emailCc") != null && !jsonObj.get("emailCc").isJsonNull()) && !jsonObj.get("emailCc").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("emailBcc") != null && !jsonObj.get("emailBcc").isJsonNull()) && !jsonObj.get("emailBcc").isJsonPrimitive()) {
