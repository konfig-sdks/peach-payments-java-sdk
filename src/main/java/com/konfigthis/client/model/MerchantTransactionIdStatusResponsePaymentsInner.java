...
public class MerchantTransactionIdStatusResponsePaymentsInner {
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner() {
  }

  public MerchantTransactionIdStatusResponsePaymentsInner id(String id) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner paymentType(PaymentType paymentType) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner paymentBrand(PaymentBrand paymentBrand) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner amount(String amount) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner currency(String currency) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner merchantTransactionId(String merchantTransactionId) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner result(Result result) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner resultDetails(ResultDetails resultDetails) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner connectorTxID1(String connectorTxID1) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner timestamp(OffsetDateTime timestamp) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner customParameters(Object customParameters) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner card(ResponseCard card) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner merchantInvoiceId(String merchantInvoiceId) {
  ...
  **/
  ...
  public MerchantTransactionIdStatusResponsePaymentsInner recon(Recon recon) {
  ...
  **/
   ...
   * @return the MerchantTransactionIdStatusResponsePaymentsInner instance itself
   */
  public MerchantTransactionIdStatusResponsePaymentsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MerchantTransactionIdStatusResponsePaymentsInner merchantTransactionIdStatusResponsePaymentsInner = (MerchantTransactionIdStatusResponsePaymentsInner) o;
    return Objects.equals(this.id, merchantTransactionIdStatusResponsePaymentsInner.id) &&
        Objects.equals(this.paymentType, merchantTransactionIdStatusResponsePaymentsInner.paymentType) &&
        Objects.equals(this.paymentBrand, merchantTransactionIdStatusResponsePaymentsInner.paymentBrand) &&
        Objects.equals(this.amount, merchantTransactionIdStatusResponsePaymentsInner.amount) &&
        Objects.equals(this.currency, merchantTransactionIdStatusResponsePaymentsInner.currency) &&
        Objects.equals(this.merchantTransactionId, merchantTransactionIdStatusResponsePaymentsInner.merchantTransactionId) &&
        Objects.equals(this.result, merchantTransactionIdStatusResponsePaymentsInner.result) &&
        Objects.equals(this.resultDetails, merchantTransactionIdStatusResponsePaymentsInner.resultDetails) &&
        Objects.equals(this.connectorTxID1, merchantTransactionIdStatusResponsePaymentsInner.connectorTxID1) &&
        Objects.equals(this.timestamp, merchantTransactionIdStatusResponsePaymentsInner.timestamp) &&
        Objects.equals(this.customParameters, merchantTransactionIdStatusResponsePaymentsInner.customParameters) &&
        Objects.equals(this.card, merchantTransactionIdStatusResponsePaymentsInner.card) &&
        Objects.equals(this.merchantInvoiceId, merchantTransactionIdStatusResponsePaymentsInner.merchantInvoiceId) &&
        Objects.equals(this.recon, merchantTransactionIdStatusResponsePaymentsInner.recon)&&
        Objects.equals(this.additionalProperties, merchantTransactionIdStatusResponsePaymentsInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, paymentType, paymentBrand, amount, currency, merchantTransactionId, result, resultDetails, connectorTxID1, timestamp, customParameters, card, merchantInvoiceId, recon, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MerchantTransactionIdStatusResponsePaymentsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MerchantTransactionIdStatusResponsePaymentsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MerchantTransactionIdStatusResponsePaymentsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantTransactionIdStatusResponsePaymentsInner is not found in the empty JSON string", MerchantTransactionIdStatusResponsePaymentsInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MerchantTransactionIdStatusResponsePaymentsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MerchantTransactionIdStatusResponsePaymentsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MerchantTransactionIdStatusResponsePaymentsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MerchantTransactionIdStatusResponsePaymentsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MerchantTransactionIdStatusResponsePaymentsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MerchantTransactionIdStatusResponsePaymentsInner>() {
           @Override
           public void write(JsonWriter out, MerchantTransactionIdStatusResponsePaymentsInner value) throws IOException {
           ...
           @Override
           public MerchantTransactionIdStatusResponsePaymentsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MerchantTransactionIdStatusResponsePaymentsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MerchantTransactionIdStatusResponsePaymentsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MerchantTransactionIdStatusResponsePaymentsInner
  * @throws IOException if the JSON string is invalid with respect to MerchantTransactionIdStatusResponsePaymentsInner
  */
  public static MerchantTransactionIdStatusResponsePaymentsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MerchantTransactionIdStatusResponsePaymentsInner.class);
  }

 /**
  * Convert an instance of MerchantTransactionIdStatusResponsePaymentsInner to an JSON string
  *
  * @return JSON string
  */
